...
- 専門分野: "予算管理・財政分析"
- 役割: 施策に必要な予算を精密に見積もり、コスト内訳を詳細分析する
...
```json
{
  "policy_agents": [
    ...
    {"name": "予算管理専門家", "expertise": "予算管理・財政分析", "system_prompt": "予算見積用プロンプト"}
  ],
  "citizen_agents": [
    {
      "name": "田中花子",
...
{{
  ...
  "detailed_policy": "施策詳細（具体的な施策内容、支援内容、対象者の条件、実施方法、予算管理専門家による詳細な予算内訳、必要な体制、考慮すべき事項（法律、既存施策との関係など）を詳しく記載、800-1000文字）",
